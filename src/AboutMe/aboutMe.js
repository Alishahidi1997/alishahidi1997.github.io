...
function AboutMe() {
    ...
    return (
        <div className="col-8 align-self-center">
            ...
            <p>
    I’m a multidisciplinary software developer passionate about creating immersive games and interactive experiences using <strong>ASP.NET</strong>, <strong>Unity</strong>, <strong>C++</strong>, and <strong>C#</strong>. Over the past five years, I’ve built narrative-driven games, VR simulations, and real-time multiplayer systems, with a focus on performance, scalability, and player engagement.
</p>
<p>
